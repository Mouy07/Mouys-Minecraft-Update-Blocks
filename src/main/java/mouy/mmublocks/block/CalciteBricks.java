...
public class CalciteBricks extends Block {

    public CalciteBricks(Settings settings) {
        super(settings);
    }

    static final String BLOCK_ID = "calcite_bricks";
    public static final Block CALCITE_BRICKS = new Block(FabricBlockSettings.copyOf(Blocks.CALCITE));

    public static void registerBlock() {
        Registry.register(Registries.BLOCK, new Identifier(MouysMinecraftUpdateBlocks.MOD_ID, BLOCK_ID), CALCITE_BRICKS);
        registerBlockItem(CALCITE_BRICKS);
    }
